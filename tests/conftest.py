"""Pytest fixture for setting up project using this cookiecutter template."""
import sys
import pytest
import shutil
...
def system_check(basename):
    """Return system platform basename."""
...
def default_baked_project(tmpdir_factory, request):
    """Pytest fixture for project setup using this cookiecutter template."""
